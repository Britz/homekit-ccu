...
const testCase = 'VIR-LG-ONOFF-CH.json'
...
describe('HomeKit-CCU Tests ' + testCase, () => {
  ...
  it('HomeKit-CCU check Stare off', (done) => {
    that.server._ccu.fireEvent('VirtualDevices.1079891751ABCD:1.STATE', 0)
  ...
  it('HomeKit-CCU check State on', (done) => {
    that.server._ccu.fireEvent('VirtualDevices.1079891751ABCD:1.STATE', 1)
    let accessory = that.server._publishedAccessories[Object.keys(that.server._publishedAccessories)[0]]
